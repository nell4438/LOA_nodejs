<template>
  <div>
    ...
    <!-- ============================================================================================== -->
    <v-row no-gutters>
      <a-tooltip title="File Leave of Absence" placement="topRight">
        <v-btn
          style="
            margin-bottom: 45px;
          ...
          fixed
        >
          <v-icon size="30px"> mdi-file-edit </v-icon>
        </v-btn>
      </a-tooltip>
      <!-- ============================================================================================== -->
      ...
      <v-col style="padding-left: 5px; padding-right: 5px; padding-top: 6px">
        ...
        >
          <a-collapse-panel key="1" header="Personal Information">
            <v-row>
              <v-col cols="2" align="center" justify="center" style="padding-top: 25px">
                <a-avatar
                  :src="objUserInformation.Avatar"
                  :size="145"
                  shape="square"
              ...
              <v-col cols="4">
                ...
                <a-input
                  v-model="objUserInformation.EmployeeName"
                  size="small"
                ...
                <a-input
                  v-model="objUserInformation.DepartmentName"
                  size="small"
                  class="PersonalInformation"
                  disabled
                ></a-input>
                ...
                <a-input
                  v-model="objUserInformation.SectionName"
                  size="small"
                  class="PersonalInformation"
                  disabled
                ></a-input>
                ...
                <a-input
                  v-model="objUserInformation.TeamName"
                  size="small"
                  class="PersonalInformation"
                  disabled
                ></a-input>
              ...
              <v-col cols="4">
                ...
                <a-input
                  v-model="objUserInformation.EmployeeStatus"
                  size="small"
                  class="PersonalInformation"
                  disabled
                ></a-input>
                ...
                <a-input
                  v-model="objUserInformation.FormattedDateHired"
                  size="small"
                  class="PersonalInformation"
                  disabled
                ></a-input>
                ...
                <a-input
                  v-model="objUserInformation.FormattedDateRenew"
                  size="small"
                  class="PersonalInformation"
                  disabled
                ></a-input>
                ...
                <a-input
                  v-model="objUserInformation.FormattedLengthOfService"
                  size="small"
                  class="PersonalInformation"
                  disabled
                ></a-input>
              ...
              <!-- <v-col cols="2"> -->
              <!-- <span style="color:black; font-style:arial; font-size:12px; font-weight:bold;"> Total Vacation Leave: </span>
                <a-input v-model="objUserInformation.TotalVacationLeave" size="small" class="PersonalInformation" disabled></a-input> -->

              <!-- <span style="color:black; font-style:arial; font-size:12px; font-weight:bold;"> Total Vacation Used: </span>
                <a-input v-model="objUserInformation.TotalVacationUsed" size="small" class="PersonalInformation" disabled></a-input>

                <span style="color:black; font-style:arial; font-size:12px; font-weight:bold;"> Remaining Leave: </span>
                <a-input v-model="objUserInformation.RemainingLeave" size="small" class="PersonalInformation" disabled></a-input>

                <span style="color:black; font-style:arial; font-size:12px; font-weight:bold;"> No. of Filed Leave w/o Pay: </span>
                <a-input v-model="objUserInformation.LeaveWithoutPay" size="small" class="PersonalInformation" disabled></a-input> -->
              <!-- </v-col> -->
              ...
              <v-col cols="2">
                ...
                <a-input
                  v-model="objUserInformation.TotalLeaveCredits"
                  size="small"
                  class="PersonalInformation"
                  disabled
                ></a-input>
                ...
                <a-input
                  v-model="objUserInformation.TotalLeaveUsed"
                  size="small"
                  class="PersonalInformation"
                  disabled
                ></a-input>
                ...
                <a-input
                  v-model="objUserInformation.RemainingLeave"
                  size="small"
                  class="PersonalInformation"
                  disabled
                ></a-input>
                ...
                <a-input
                  v-model="objUserInformation.LeaveWithoutPay"
                  size="small"
                  class="PersonalInformation"
                  disabled
                ></a-input>
      ...
      >
        ...
        >
          <v-layout>
            ...
            <!-- <div style="padding-left:5px; padding-right:30px;"> - Canceled </div> -->
            <v-spacer></v-spacer>
    ...
    <v-row no-gutters>
      <v-col style="padding-left: 5px; padding-right: 5px; padding-top: 5px">
        <div
          style="border: 1px black solid; border-radius: 5px 5px 0px 0px; height: 45px"
        >
          <v-row
            class="disable-select"
            style="
        ...
        <a-list
          v-else
          :data-source="compUserLeaves"
          size="small"
          item-layout="horizontal"
          :class="`${blnCollapseVisible === true ? 'LeaveList1' : 'LeaveList2'}`"
            ...
            <a-list-item-meta @dblclick="ClickFiledLeave(item)">
              ...
              >
                <v-row class="disable-select" align="center" justify="center">
                  ...
                  <v-col>
                    <span style="padding-left: 10px"> {{ item.NoOfWorkingDays }} </span>
                  </v-col>
                  <v-col cols="2">
                    <a-input
                  ...
                  <v-col v-else :style="`padding-top:10px;`">
                    ...
                    >
                      <div
                        style="padding-top: 15px; padding-bottom: 15px; height: 40px"
                      ></div>
                    </div>
                  </v-col>
                  <!-- ================================= -->
    ...
    >
        ...
        <div style="width: 400px; padding-right: 20px">
          ...
          <v-layout style="color: red; font-size: 15px">
            ...
            <span v-if="intLeaveTypeError === 1">
              <v-icon small style="color: red"> mdi-alert-circle-outline </v-icon> Field
              required.
            </span>
          </v-layout>
        </div>
        ...
        <div style="width: 450px; padding-right: 20px">
          ...
          <v-layout style="color: red; font-size: 15px">
            ...
            <span v-else-if="intLeaveFromError === 2">
              <v-icon small style="color: red"> mdi-alert-circle-outline </v-icon> Invalid
              Date Range.
            </span>
            <!-- <span v-else-if="intLeaveFromError === 3"> <v-icon small style="color:red;"> mdi-alert-circle-outline </v-icon> Late Filing. </span> -->
          </v-layout>
        </div>
      ...
      <v-layout style="padding-top: 5px">
        ...
        <div style="width: 500px; padding-right: 40px">
          ...
          <v-layout style="color: red; font-size: 15px">
            <v-spacer></v-spacer>
            <span v-if="intNoOfWorkingDaysError === 1" style="padding-right: 77px">
              <v-icon small style="color: red"> mdi-alert-circle-outline </v-icon> Field
              required.
            </span>
            <span v-else-if="intNoOfWorkingDaysError === 2" style="padding-right: 77px">
              <v-icon small style="color: red"> mdi-alert-circle-outline </v-icon> Invalid
              value.
            </span>
          </v-layout>
      ...
      <v-layout style="padding-top: 5px">
        <div style="width: 1200px">
          ...
          <a-input
            ...
            placeholder="Type here..."
            type="textarea"
            :style="`width:100%; font-size:15px; color:black; border:1px solid; border-color:${
              intReasonError === 0 ? 'black' : 'red'
            }; border-radius:4px;`"
            @change="ChangeReason()"
            :disabled="blnFilingLoadingSave"
...
export default {
    ...
    compUserLeaves() {
      ...
      if (
        ...
        data = data.filter((rec) => {
          return (
            moment(new Date(rec.FiledDate), "YYYY/MM/DD").format("YYYY/MM/DD") >=
      ...
      if (
        ...
        data = data.filter((rec) => {
          return (
            moment(new Date(rec.LeaveFrom), "YYYY/MM/DD").format("YYYY/MM/DD") >=
  ...
  methods: {
    ...
    // ============================================================= //
    RunSocketIO() {
      this.$socket.on("GetUsersLeaveTable", () => {
        this.GetUserLeaves();
      });
    },
    GetUserInformation() {
      ...
      axios
        ...
        .then((res) => {
          ...
          this.objUserInformation.Avatar = `${this.avatar_API}${this.DecryptText(
            this.$store.state.loa_user
          )}.jpg`;
          this.objUserInformation.FormattedDateHired = moment(
            new Date(this.objUserInformation.DateHired)
          ).format("MMMM DD, YYYY");
          ...
          this.objUserInformation.FormattedDateRenew = moment(
            new Date(this.objUserInformation.DateHired),
            "YYYY/MM/DD"
          )
            .add(Years, "years")
            .format("MMMM DD, YYYY");
          this.objUserInformation.FormattedLengthOfService =
            Years + " year(s), " + Months + " month(s), and " + Days + " day(s) ";
          // let compcode = this.objUserInformation.CompanyCode == '00' ? 'pv' : this.objUserInformation.CompanyCode == '10' ? 'SCD' : this.objUserInformation.CompanyCode == '20' ? 'HTI' : this.objUserInformation.CompanyCode == '30' ? 'HRD' : 'DBAT'
          ...
          // let UserLeaveCreditsAPI = `${this.employeesLeaveCredits_API}${compcode}/${this.DecryptText(this.$store.state.loa_user)}`
          // console.log("VL", UserLeaveCreditsAPI )
          // if(this.ref.ShortName == 'HTI'){
          axios
            .get(
              `http://10.169.142.40:6001/api/GetLeaveData${
                this.ref.ShortName
              }/${this.DecryptText(this.$store.state.loa_user)}`
            )
            .then((res) => {
              let LeaveCredits = res.data[0];

              this.newLeaveCredits = LeaveCredits; //locelyn

              // console.log('datas',LeaveCredits) // ditos
              this.objUserInformation.TotalVacationLeave = LeaveCredits.VacBegin;
              this.objUserInformation.TotalVacationUsed = LeaveCredits.VacUsed;
              this.objUserInformation.TotalSickLeave = LeaveCredits.SickLeaveBeg;
              this.objUserInformation.TotalSickUsed = LeaveCredits.SickLeaveUsed;
              this.objUserInformation.TotalLeaveCredits = `VL: ${LeaveCredits.VacBegin}       SL: ${LeaveCredits.SickLeaveBeg} `;
              this.objUserInformation.TotalLeaveUsed = `VL: ${LeaveCredits.VacUsed}       SL: ${LeaveCredits.SickLeaveUsed}`; //old
              this.objUserInformation.RemainingVacationLeave =
                this.objUserInformation.TotalVacationLeave - LeaveCredits.VacUsed;
              this.objUserInformation.RemainingSickLeave =
                this.objUserInformation.TotalSickLeave - LeaveCredits.SickLeaveUsed;
              this.objUserInformation.RemainingLeave = `VL: ${this.objUserInformation.RemainingVacationLeave}         SL: ${this.objUserInformation.RemainingSickLeave}`; //old

              ///////////////////////// 08-02-2023 locelyn
              // if(this.objUserInformation.RemainingVacationLeave < 1 ){
              //   this.objUserInformation.RemainingLeave = `VL: 0         SL: ${this.objUserInformation.RemainingSickLeave}`
              // }else{
              //   this.objUserInformation.RemainingLeave = `VL: ${this.objUserInformation.RemainingVacationLeave}         SL: ${this.objUserInformation.RemainingSickLeave}`
              // }

              // if (LeaveCredits.VacUsed > LeaveCredits.VacBegin ){
              //   this.objUserInformation.TotalLeaveUsed = `VL: 10        SL: ${LeaveCredits.SickLeaveUsed}`
              //   if(LeaveCredits.VacBegin == 0){
              //     this.objUserInformation.TotalLeaveUsed = `VL: 0      SL: ${LeaveCredits.SickLeaveUsed}`
              //     // this.objUserInformation.LeaveWithoutPay = LeaveCredits.VacUsed
              //   }
              //   // else {

              //   // }
              // } else {
              //   this.objUserInformation.TotalLeaveUsed = `VL: ${LeaveCredits.VacUsed}       SL: ${LeaveCredits.SickLeaveUsed}`
              // }
              ///////////////////////// 08-02-2023 locelyn
    ...
    GetPosition() {
      ...
      axios.get(CheckPositionURL).then((Position) => {
        this.objUserInformation.Position = Position.data[0].Position;
      });
    },
    GetUserLeaves() {
      let LeaveCounter = 0;
      ...
      let GetUserLeavesURL = `${this.api}GetUserLeaves?EmployeeCode=${this.objUserInformation.EmployeeCode}`;
      axios.get(GetUserLeavesURL).then((res) => {
        ...
        this.objUserInformation.LeaveWithoutPay = 0; //old
        // this.objUserInformation.LeaveWithoutPay = 0 + (this.newLeaveCredits.VacUsed - 10) //locelyn

        // if (this.newLeaveCredits.VacBegin == 0){
        //   this.objUserInformation.LeaveWithoutPay = 0
        // }
        // else{
        //   this.objUserInformation.LeaveWithoutPay = 0 + (this.newLeaveCredits.VacUsed - 10)
        // }
        ...
        LeaveData.forEach((Data) => {
          ...
          if (Data.WithPay === 0 || Data.excess) {
            // comment para d agad mag save sa database
            // this.objUserInformation.LeaveWithoutPay = this.objUserInformation.LeaveWithoutPay + 1
            // this.objUserInformation.LeaveWithoutPay += Data.NoOfWorkingDays //07-27-2023
            this.objUserInformation.LeaveWithoutPay += Data.excess;
          }

          let RecommendingBasicInfoAPI = `${this.basicInfo_API}${Data.RecommendingEmployeeCode}`;
          axios
            .get(RecommendingBasicInfoAPI, { headers: { "master-api": this.header_API } })
            .then((Recommending) => {
              ...
              axios
                .get(ApproverBasicInfoAPI, { headers: { "master-api": this.header_API } })
                .then((Approver) => {
                  ...
                  axios
                    ...
                    .then((Admin) => {
                      ...
                      if (LeaveCounter === UserLeaves.length) {
                        this.arrUserLeaves = _.orderBy(
                          UserLeaves,
    ...
    CheckWithPayEnable(LeaveTypeCode) {
      if (LeaveTypeCode === undefined || LeaveTypeCode === null || LeaveTypeCode === "") {
        this.objFileLeave.isWithPay = false;
      } else if (
        LeaveTypeCode === "2" &&
        this.objUserInformation.RemainingSickLeave > 0
      ) {
        this.objFileLeave.isWithPay = true;
      } else if (
        LeaveTypeCode !== "2" &&
        this.objUserInformation.RemainingVacationLeave > 0
      ) {
        this.objFileLeave.isWithPay = true;
    ...
    ChangeLeaveType() {
      ...
      this.CheckWithPayEnable(this.objFileLeave.LeaveTypeCode);
    },
    ChangeLeaveFrom() {
      // console.log('d',item)
      // if(this.objFileLeave.FiledDate > this.objFileLeave.LeaveFrom){
      //   alert('tama')
      // }
    ...
    async FileLeaveOfAbsenceSave() {
      ...
      axios.get(GetNextLeaveOfAbsenceIDURL).then((res) => {
        ...
        let FileQuery = `INSERT INTO dbo.LeaveOfAbsences
                            ( LeaveOfAbsenceID, CompanyCode, DepartmentCode, SectionCode, TeamCode, Position, EmployeeCode, DateRenewal, TotalVacLeave, TotalSickLeave, LeaveID , LeaveTypeCode, LeaveFrom,LeaveTo, FiledDate, NoOfWorkingDays, isFiled, WithPay,excess, ReasonForLeave, CreatedDate, UpdatedDate, UpdatedBy )
                            VALUES 
                            ( ${Data.NextLeaveOfAbsenceID},
                              '${this.objUserInformation.CompanyCode}',
                              '${this.objUserInformation.DepartmentCode}',
                              '${this.objUserInformation.SectionCode}',
                              '${this.objUserInformation.TeamCode}',
                              '${this.objUserInformation.Position}',
                              '${this.objUserInformation.EmployeeCode}',
                              '${moment(
                                new Date(this.objUserInformation.FormattedDateRenew)
                              ).format("YYYY/MM/DD")}',
                              ${this.objUserInformation.TotalVacationLeave},
                              ${this.objUserInformation.TotalSickLeave},
                              ${holdID}, 
                              '${this.objFileLeave.LeaveTypeCode}',
                              '${moment(new Date(this.objFileLeave.LeaveFrom)).format(
                                "YYYY/MM/DD"
                              )}',
                              '${moment(new Date(this.objFileLeave.LeaveTo)).format(
                                "YYYY/MM/DD"
                              )}',
                              '${moment(new Date(this.objFileLeave.FiledDate)).format(
                                "YYYY/MM/DD"
                              )}',
                              ${this.objFileLeave.NoOfWorkingDays},
          ...
          .then(() => {
            this.$notification.success({
              ...
              description: (
                <div class="disable-select NotificationDescription">
                  {" "}
                  Leave has been submitted. Please wait for approval from leader(s) and/or
                  admin.{" "}
                </div>
              ),
            });
    ...
    FiledLeaveRemoveFiles() {
      if (this.arrAttachmentsToDelete.length > 0) {
        ...
        axios.post(FileDeleteURL, this.arrAttachmentsToDelete).then((res) => {
          if (res.data) {
